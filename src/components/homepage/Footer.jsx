    ...
    const footerNavs = [
        {
            ...
            items: [
                {
                    href: '/education-research/aboutUs',
                    name: ' About School'
                },
                {
                    href: '/vision/ourMotto',
                    name: 'Our Vision'
                },
                {
                    href: '/',
        ...
        {
            label: "Education & Research Society",
            items: [
                {
                    href: 'javascript:void()',
                    name: 'Partners'
                ...
                {
                    href: '/education-research/careers',
                    name: 'Careers'
                },
            ],
        }
